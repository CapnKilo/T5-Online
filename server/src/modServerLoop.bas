        ...
        For i = 1 To Player_HighIndex
            If IsPlaying(i) Then
                If Tick > tmr25 Then
                    ...
                    If TempPlayer(i).SkillBuffer.Skill > 0 Then
                        If timeGetTime > TempPlayer(i).SkillBuffer.Timer + (Skill(Player(i).Skill(TempPlayer(i).SkillBuffer.Skill)).CastTime * 1000) Then
                            CastSkill i, TempPlayer(i).SkillBuffer.Skill, TempPlayer(i).SkillBuffer.target, TempPlayer(i).SkillBuffer.tType
                            TempPlayer(i).SkillBuffer.Skill = 0
                            TempPlayer(i).SkillBuffer.Timer = 0
                            TempPlayer(i).SkillBuffer.target = 0
                            TempPlayer(i).SkillBuffer.tType = 0
                        End If
                    End If
