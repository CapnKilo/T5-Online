...
' Holds the last direction to cut down on network traffic
...
Public PlayerSkills(1 To MAX_PLAYER_SkillS) As Long
Public InventoryItemSelected As Long
Public SkillBuffer As Long
Public SkillBufferTimer As Long
Public SkillCD(1 To MAX_PLAYER_SkillS) As Long
...
Public ConvEditorLoaded As Boolean
Public QuestEditorLoaded As Boolean
...
Public Skill_Changed(1 To MAX_SkillS) As Boolean
