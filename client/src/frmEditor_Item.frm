...
Begin VB.Form frmEditor_Item 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox cmbType 
         Height          =   300
         ItemData        =   "frmEditor_Item.frx":339D
         Left            =   120
         List            =   "frmEditor_Item.frx":33BC
         Style           =   2  'Dropdown List
         TabIndex        =   20
         Top             =   1200
         Width           =   2655
   ...
   Begin VB.Frame fraVitals 
      ...
      Begin VB.CheckBox chkInstant 
         ...
         Width           =   1455
      End
      Begin VB.HScrollBar scrlCastSkill 
         Height          =   255
         Left            =   120
         Max             =   255
         TabIndex        =   64
...
Private Sub cmbType_Click()
    ...
    If (cmbType.ListIndex = ITEM_TYPE_Skill) Then
...
Private Sub scrlSkill_Change()
    ...
    If Len(Trim$(Skill(scrlSkill.value).name)) > 0 Then
        lblSkillName.Caption = "Name: " & Trim$(Skill(scrlSkill.value).name)
    Else
        lblSkillName.Caption = "Name: None"
    End If
    
    lblSkill.Caption = "Skill: " & scrlSkill.value
